                                             ...
                                             <div className="space-y-4">
                                                  ...
                                                  </div>
                                                  {
                                                       ...
                                                       <>
                                                            <hr />
                                                            <div>
                                                                 <p className="text-xs text-default-400">อนุมัติโดย</p>
                                                                 <div className="flex items-center gap-2">
                                                                      <p>{petition?.Approver?.Teacher?.teacherName}</p>
                                                                      <p className="text-xs text-default-400">{`<${petition?.Approver?.Teacher?.email}>`}</p>
                                                                 </div>
                                                            </div>
                                                       </>
                                                  }
