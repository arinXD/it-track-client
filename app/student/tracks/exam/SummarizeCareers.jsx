...
const SummarizeCareer = ({ next, prev, data }) => {
    ...
    return (
        <section>
            <section className='bg-gray-100 min-h-screen lg:p-8 rounded-sm'>
                <section className='max-w-4xl mx-auto bg-white md:shadow-lg rounded-lg overflow-hidden'>
                    <header className="bg-blue-600 text-white p-6">
                        <h1 className="text-2xl md:text-3xl font-bold">ผลสรุปอาชีพ</h1>
                    </header>
                    <div className="p-2 space-y-2 md:p-6 md:space-y-6">
                        <section className='p-3 md:p-6 bg-blue-50 rounded-lg '>
                            <h2 className="text-xl md:text-2xl font-semibold text-blue-800 mb-4">อาชีพที่เลือกทั้งหมด {careersScores?.length} อาชีพ ได้แก่</h2>
                        ...
                        <section className='flex flex-col gap-3 md:gap-6  p-3 md:p-6 bg-blue-50 rounded-lg'>
                            <section>
                                <h2 className="text-xl md:text-2xl font-semibold text-blue-800 mb-4 md:mb-6">สรุปผลคะแนนในแต่ละแทร็ก (อาชีพละ 5 คะแนน)</h2>
            ...
            <div className="w-full flex justify-between p-4 md:mt-8">
                <div
                    onClick={prev}
                ...
                >
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-sm md:text-base">ผลสรุปแบบประเมิน</span>
                    </div>
                </div>
                <div
                    onClick={next}
                ...
                >
                    <div className="flex flex-col">
                        <span className="text-xs md:text-sm text-default-400">Final</span>
                        <span className="text-sm md:text-base">คำแนะนำ</span>
                    </div>
